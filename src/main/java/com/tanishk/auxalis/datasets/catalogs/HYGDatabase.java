...
public class HYGDatabase implements StarCatalog {
  ...
  public HYGDatabase() throws IOException {
    ...
    Scanner wikiLinks = new Scanner(new GZIPInputStream(HYGDatabase.class.getClassLoader()
        .getResourceAsStream("com/tanishk/auxalis/datasets/hyg_wikipedia_links.txt.gz")));
    ...
    InputStream resourceAsStream = HYGDatabase.class.getClassLoader().getResourceAsStream("com/tanishk/auxalis/datasets/hygdata_v3.csv.gz");
