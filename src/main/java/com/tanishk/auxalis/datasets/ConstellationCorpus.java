...
import com.tanishk.auxalis.datasets.catalogs.GlieseCatalog;
...
public class ConstellationCorpus {
  ...
  public ConstellationCorpus() throws IOException {
    InputStream resourceAsStream = GlieseCatalog.class.getClassLoader().getResourceAsStream("com/tanishk/auxalis/datasets/constellations.txt.gz");
